...
class. This restoring feature is was also used in the
[`xts::reclass()`](https://rdrr.io/pkg/xts/man/reclass.html) function of
the [xts](https://CRAN.R-project.org/package=xts) package.
